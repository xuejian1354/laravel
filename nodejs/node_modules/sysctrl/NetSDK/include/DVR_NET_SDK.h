...
typedef void (CALLBACK *LIVE_DATA_CALLBACK_EX)(LONG lLiveHandle, UINT dataType, BYTE *pBuffer, UINT dataLen, void *pUser);
...
NET_SDK_API LONG CALL_METHOD NET_SDK_LivePlayEx(LONG lUserID, LPNET_SDK_CLIENTINFO lpClientInfo, LIVE_DATA_CALLBACK_EX fLiveDataCallBack = NULL, void* pUser = NULL);
...
NET_SDK_API BOOL CALL_METHOD NET_SDK_SetLiveDataCallBackEx(LONG lLiveHandle,LIVE_DATA_CALLBACK_EX fLiveDataCallBack, void *pUser);
...
NET_SDK_API BOOL CALL_METHOD NET_SDK_PTZAutoScan(LONG lLiveHandle, DWORD dwPTZAutoScanCmd, DWORD dwSpeed);
...
NET_SDK_API LONG CALL_METHOD NET_SDK_PlayBackByTimeEx(LONG lUserID,LONG *pChannels, LONG channelNum, DD_TIME * lpStartTime, DD_TIME * lpStopTime, HWND *hWnds, BOOL bFirstStream);
