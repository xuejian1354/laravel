...
class AreaboxcontentTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach (Area::all() as $area) {
        	...
        	elseif ($area->type == '鱼塘') {
        	    Areaboxcontent::create(['box_id' => 8, 'type' => 17, 'area_sn' => $area->sn, 'val' => '未知']);
        	    Areaboxcontent::create(['box_id' => 9, 'type' => 18, 'area_sn' => $area->sn, 'val' => '未知']);
        	    Areaboxcontent::create(['box_id' => 10, 'type' => 19, 'area_sn' => $area->sn, 'val' => '未知']);
        	}
        }
    }
}
