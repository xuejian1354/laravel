...
<head>
  ...
  <title>{{ \App\Model\Globalval::getVal('title').' | '.$select_menus[0]->name}}
...
<div class="wrapper">
  ...
  <!-- Main Header -->
  @include(config('cullivebefore.mainrouter').'.admin.header')
  <!-- Left side column. contains the logo and sidebar -->
  @include(config('cullivebefore.mainrouter').'.admin.mainside')
  ...
  <!-- Main Footer -->
  @include(config('cullivebefore.mainrouter').'.admin.footer')
